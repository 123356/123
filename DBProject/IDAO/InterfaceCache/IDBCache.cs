   ...
   public interface IDBCache
    {
        ...
        /// <returns></returns>
         bool StringSet(List<KeyValuePair<object, object>> keyValues);
        ...
        /// <returns></returns>
        IList<string> StringGet<T>(List<string> listKey);
        ...
        /// <returns></returns>
        long HashDelete(string key, List<object> dataKeys);
