        ...
        Organization.prototype = {
            ...
            loadEvents: function() {
                ...
                $('.getselect').on('click', function() {
                        ...
                        for (var a = 0, str = []; a < arr.length; a++) {
                            str.push(
                                `<span class="meter" data-id="${arr[a].id.substring(0, arr[a].id.indexOf('_'))}">${arr[a].name}<i class="close">×</i></span>`
                            );
                        }
                        if (morefun) {
                            $('.reduction').append(str.join(''));
                        } else {
                            $('.addition').append(str.join(''));
                        }
                    ...
                    //重置选中按钮
                $('.getselect,noselect').on('click', function() {
                        var treeObj = $.fn.zTree.getZTreeObj('meterztree');
                ...
                $('.getselect  ').on('click', function() {
                    ...
                    console.log($('.addition').attr('data-id'))
                    console.log($('.reduction').attr('data-id'))
                })
                ...
                $('.search').on('input', function() {
                    ...
                    var nodes = treeObj.getNodesByParamFuzzy("name", $(this).val());
            ...
            GetCidView: function(ids) {
                ...
                var cid = this.cidData;
                for (var a = 0, arr = []; a < cid.length; a++) {
                    if ($.inArray(cid[a].CID, ids) > -1) {
                        arr.push(
