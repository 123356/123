...
function jsonp(url) {
	...
	setTimeout(function(){
		var urls = []; 
        urls[0] = 'https://sapi.k780.com/?app=weather.future&weaid=' + cityName + '&&appkey=42341&sign=a7b49e3c044fd0f81f2d06f2519cf3a0&format=json&jsoncallback=getWeather_week&weaid=' + encodeURI(cityName);
