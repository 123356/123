...
function showinfomessage(marker, point, data) {
    ...
    if (data.Type == 1) {
        ...
        html += '<tr style=""><td style="padding-top:5px;"><i class="iconfont icon-lvyouchengshijianzhucity-dalouxiezilou"></i><span style="font-weight:bold">' + data.UnitName + '</span><a href="/Es/UserView?id=' + data.UnitID + '">详情&gt;</a>' + isAlarm + '</td></tr>'
        ...
        html += '<tr style=""><td style="padding-top:5px;"><i class="iconfont icon-lvyouchengshijianzhucity-dalouxiezilou"></i>' + data.UnitName + '<a href="/Es/UserView?id=' + data.UnitID + '">详情&gt;</a>' + isAlarm + '</td></tr>'
