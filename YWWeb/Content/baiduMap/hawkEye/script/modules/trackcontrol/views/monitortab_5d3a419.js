      ...
      render: function render() {
          ...
          return _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                  'div',
                  { className: 'monitorAll', style: { color: monitorListTab === 'monitorBottomLineLeft' ? '#40af94' : '' }, onClick: this.handleChangeMonitorList },
                  '全部(',
                  all,
                  ')'
              ),
              _react2['default'].createElement(
                  'div',
                  { className: 'monitorOnline', style: { color: monitorListTab === 'monitorBottomLineMid' ? '#40af94' : '' }, onClick: this.handleChangeMonitorList },
                  '在线(',
                  online,
                  ')'
              ),
              _react2['default'].createElement(
                  'div',
                  { className: 'monitorOffline', style: { color: monitorListTab === 'monitorBottomLineRight' ? '#40af94' : '' }, onClick: this.handleChangeMonitorList },
                  '离线(',
                  offline,
                  ')'
              ),
