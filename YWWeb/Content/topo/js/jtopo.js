! function(window) {
    function Element() {
        this.initialize = function() { this.elementType = "element", this.serializedProperties = ["elementType"], this.propertiesStack = [], this._id = "" + (new Date).getTime() }, this.distroy = function() {}, this.removeHandler = function() {}, this.attr = function(t, e) {
...
function(JTopo) {
    function MessageBus(t) {
        ...
        this.name = t, this.messageMap = {}, this.messageCount = 0, this.subscribe = function(t, i) {
            ...
            if (null != n)
                for (var h = 0; h < n.length; h++) s ? ! function(t, e) { setTimeout(function() { t(e) }, 10) }(n[h], i) : n[h](i)
        }
    }

    function getDistance(t, e, i, s) { var n, h; return null == i && null == s ? (n = e.x - t.x, h = e.y - t.y) : (n = i - t, h = s - e), Math.sqrt(n * n + h * h) }

    function getElementsBound(t) {
        for (var e = { left: Number.MAX_VALUE, right: Number.MIN_VALUE, top: Number.MAX_VALUE, bottom: Number.MIN_VALUE }, i = 0; i < t.length; i++) {
            var s = t[i];
    ...
    function mouseCoords(t) { return t = cloneEvent(t), t.pageX || (t.pageX = t.clientX + document.body.scrollLeft - document.body.clientLeft, t.pageY = t.clientY + document.body.scrollTop - document.body.clientTop), t }

    function getEventPosition(t) { return t = mouseCoords(t) }
    ...
    function rotatePoint(t, e, i, s, n) {
        var h = i - t,
            ...
            a = Math.sqrt(h * h + o * o),
            r = Math.atan2(o, h) + n;
        return { x: t + Math.cos(r) * a, y: e + Math.sin(r) * a }
    }
    ...
    function $foreach(t, e, i) {
        function s(n) { n != t.length && (e(t[n]), setTimeout(function() { s(++n) }, i)) }
        if (0 != t.length) {
            var n = 0;
            s(n)
        }
    ...
    function $for(t, e, i, s) {
        function n(t) { t != e && (i(e), setTimeout(function() { n(++t) }, s)) }
        if (!(t > e)) {
            var h = 0;
            n(h)
        }
    ...
    function cloneEvent(t) { var e = {}; for (var i in t) "returnValue" != i && "keyLocation" != i && (e[i] = t[i]); return e }

    function clone(t) { var e = {}; for (var i in t) e[i] = t[i]; return e }
    ...
    function removeFromArray(t, e) { for (var i = 0; i < t.length; i++) { var s = t[i]; if (s === e) { t = t.del(i); break } } return t }

    function randomColor() { return Math.floor(255 * Math.random()) + "," + Math.floor(255 * Math.random()) + "," + Math.floor(255 * Math.random()) }

    function isIntsect() {}

    function getProperties(t, e) { for (var i = "", s = 0; s < e.length; s++) { s > 0 && (i += ","); var n = t[e[s]]; "string" == typeof n ? n = '"' + n + '"' : void 0 == n && (n = null), i += e[s] + ":" + n } return i }
    ...
    function genImageAlarm(t, e) { var i = t.src + e; if (alarmImageCache[i]) return alarmImageCache[i]; var s = new Image; return s.src = changeColor(graphics, t, e), alarmImageCache[i] = s, s }
    ...
    function isPointInLineSeg(t, e, i) { return inRange(t, i.x1, i.x2) && inRange(e, i.y1, i.y2) }

    function intersection(t, e) { var i, s; return t.k == e.k ? null : (1 / 0 == t.k || t.k == -1 / 0 ? (i = t.x1, s = e(t.x1)) : 1 / 0 == e.k || e.k == -1 / 0 ? (i = e.x1, s = t(e.x1)) : (i = (e.b - t.b) / (t.k - e.k), s = t(i)), 0 == isPointInLineSeg(i, s, t) ? null : 0 == isPointInLineSeg(i, s, e) ? null : { x: i, y: s }) }
    ...
    requestAnimationFrame = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame || window.oRequestAnimationFrame || function(t) { setTimeout(t, 1e3 / 24) }, Array.prototype.del = function(t) {
        if ("number" != typeof t) {
...
function(t) {
    function e(t) {
        return {
            ...
            getImage: function(e, i) {
                ...
                return t.childs.length > 0 && (o.save(), o.clearRect(0, 0, this.exportCanvas.width, this.exportCanvas.height), t.childs.forEach(function(t) { 1 == t.visible && (t.save(), t.translateX = 0, t.translateY = 0, t.scaleX = 1, t.scaleY = 1, o.scale(n, h), s.left < 0 && (t.translateX = Math.abs(s.left)), s.top < 0 && (t.translateY = Math.abs(s.top)), t.paintAll = !0, t.repaint(o), t.paintAll = !1, t.restore()) }), o.restore()), this.exportCanvas.toDataURL("image/png")
            },
            canvas: document.createElement("canvas"),
            update: function() { this.eagleImageDatas = this.getData(t) },
            setSize: function(t, e) { this.width = this.canvas.width = t, this.height = this.canvas.height = e },
            getData: function(e, i) {
                function s(t) {
                    var e = t.stage.canvas.width,
                        ...
                        s = e / t.scaleX / 2,
                        n = i / t.scaleY / 2;
                    return { translateX: t.translateX + s - s * t.scaleX, translateY: t.translateY + n - n * t.scaleY }
                }
                null != l && null != c ? this.setSize(e, i) : this.setSize(200, 160);
                var n = this.canvas.getContext("2d");
                if (t.childs.length > 0) {
                    n.save(), n.clearRect(0, 0, this.canvas.width, this.canvas.height), t.childs.forEach(function(t) { 1 == t.visible && (t.save(), t.centerAndZoom(null, null, n), t.repaint(n), t.restore()) });
                    var h = s(t.childs[0]),
                    ...
                    var u = null;
                    try { u = n.getImageData(0, 0, n.canvas.width, n.canvas.height) } catch (t) {}
                    return u
                }
                return null
            },
    ...
    function i(i) {
        ...
        function n(t) {
            document.onselectstart = function() { return !1 }, this.mouseOver = !0;
            var e = s(t);
            f.dispatchEventToScenes("mouseover", e), f.dispatchEvent("mouseover", e)
        }

        function h(t) {
            v = setTimeout(function() { g = !0 }, 500), document.onselectstart = function() { return !0 };
            var e = s(t);
        ...
        t.stage = this;
        var f = this;
        this.initialize = function(i) { d(i), this.canvas = i, this.graphics = i.getContext("2d"), this.childs = [], this.frames = 24, this.messageBus = new t.util.MessageBus, this.eagleEye = e(this), this.wheelZoom = null, this.mouseDownX = 0, this.mouseDownY = 0, this.mouseDown = !1, this.mouseOver = !1, this.needRepaint = !0, this.serializedProperties = ["frames", "wheelZoom"] }, null != i && this.initialize(i);
        var g = !0,
            v = null;
        document.oncontextmenu = function() { return g }, this.dispatchEventToScenes = function(t, e) {
            ...
            return this
        }, this.clear = function() { this.childs = [] }, this.addEventListener = function(t, e) {
            var i = this,
                s = function(t) { e.call(i, t) };
            return this.messageBus.subscribe(t, s), this
        }, this.removeEventListener = function(t) { this.messageBus.unsubscribe(t) }, this.removeAllEventListener = function() { this.messageBus = new t.util.MessageBus }, this.dispatchEvent = function(t, e) { return this.messageBus.publish(t, e), this };
        ...
        p.forEach(function(t) { m[t] = function(e) { null != e ? this.addEventListener(t, e) : this.dispatchEvent(t) } }), this.saveImageInfo = function(t, e) {
                ...
                var t = { left: Number.MAX_VALUE, right: Number.MIN_VALUE, top: Number.MAX_VALUE, bottom: Number.MIN_VALUE };
                ...
                var e = this,
                    i = '{"version":"' + t.version + '",';
                return this.serializedProperties.length, this.serializedProperties.forEach(function(t) { var s = e[t]; "string" == typeof s && (s = '"' + s + '"'), i += '"' + t + '":' + s + "," }), i += '"childs":[', this.childs.forEach(function(t) { i += t.toJson() }), i += "]", i += "}"
            },
            function() { 0 == f.frames ? setTimeout(arguments.callee, 100) : f.frames < 0 ? (f.repaint(), setTimeout(arguments.callee, 1e3 / -f.frames)) : (f.repaint(), setTimeout(arguments.callee, 1e3 / f.frames)) }(), setTimeout(function() {
            ...
            }, 1000), setTimeout(function() { f.paint() }, 1e3), setTimeout(function() { f.paint() }, 3e3)
    }
    i.prototype = {get width() { return this.canvas.width }, get height() { return this.canvas.height }, set cursor(t) { this.canvas.style.cursor = t }, get cursor() { return this.canvas.style.cursor }, set mode(t) { this.childs.forEach(function(e) { e.mode = t }) } }, t.Stage = i
}(JTopo),
function(t) {
    function e(i) {
        function s(t, e, i, s) { return function(n) { n.beginPath(), n.strokeStyle = "rgba(0,0,236,0.5)", n.fillStyle = "rgba(0,0,236,0.1)", n.rect(t, e, i, s), n.fill(), n.stroke(), n.closePath() } }
        var n = this;
        this.initialize = function() {
        ...
        }, this.initialize(), this.setBackground = function(t) { this.background = t }, this.addTo = function(t) { this.stage !== t && null != t && (this.stage = t) }, null != i && (i.add(this), this.addTo(i)), this.show = function() { this.visible = !0 }, this.hide = function() { this.visible = !1 }, this.paint = function(t) {
        ...
        }, this.repaint = function(t) { 0 != this.visible && this.paint(t) }, this.paintBackgroud = function(t) { null != this.background ? t.drawImage(this.background, 0, 0, t.canvas.width, t.canvas.height) : (t.beginPath(), t.fillStyle = "rgba(" + this.backgroundColor + "," + this.alpha + ")", t.fillRect(0, 0, t.canvas.width, t.canvas.height), t.closePath()) }, this.getDisplayedElements = function() {
            ...
            var s = e / this.scaleX / 2,
                n = i / this.scaleY / 2,
                h = { translateX: this.translateX + (s - s * this.scaleX), translateY: this.translateY + (n - n * this.scaleY) };
            return h
        ...
        }, this.paintOperations = function(t, e) { for (var i = 0; i < e.length; i++) e[i](t) }, this.findElements = function(t) { for (var e = [], i = 0; i < this.childs.length; i++) 1 == t(this.childs[i]) && e.push(this.childs[i]); return e }, this.getElementsByClass = function(t) { return this.findElements(function(e) { return e instanceof t }) }, this.addOperation = function(t) { return this.operations.push(t), this }, this.clearOperations = function() { return this.operations = [], this }, this.getElementByXY = function(e, i) {
            for (var s = null, n = this.zIndexArray.length - 1; n >= 0; n--)
                for (var h = this.zIndexArray[n], o = this.zIndexMap[h], a = o.length - 1; a >= 0; a--) { var r = o[a]; if (r instanceof t.InteractiveElement && this.isVisiable(r) && r.isInBound(e, i)) return s = r }
            return s
        }, this.add = function(t) { this.childs.push(t), null == this.zIndexMap[t.zIndex] && (this.zIndexMap[t.zIndex] = [], this.zIndexArray.push(t.zIndex), this.zIndexArray.sort(function(t, e) { return t - e })), this.zIndexMap["" + t.zIndex].push(t) }, this.remove = function(e) {
            ...
            var t = this;
            this.childs.forEach(function(e) { e.removeHandler(t) }), this.childs = [], this.operations = [], this.zIndexArray = [], this.zIndexMap = {}
        }, this.addToSelected = function(t) { this.selectedElements.push(t) }, this.cancleAllSelected = function(t) {
        ...
        }, this.touchstart = this.mousedownHander, this.touchmove = this.mousedragHandler, this.touchend = this.mousedownHander, this.keydownHandler = function(t) { this.dispatchEvent("keydown", t) }, this.keyupHandler = function(t) { this.dispatchEvent("keyup", t) }, this.addEventListener = function(t, e) {
            var i = this,
                s = function(t) { e.call(i, t) };
            return this.messageBus.subscribe(t, s), this
        }, this.removeEventListener = function(t) { this.messageBus.unsubscribe(t) }, this.removeAllEventListener = function() { this.messageBus = new t.util.MessageBus }, this.dispatchEvent = function(t, e) { return this.messageBus.publish(t, e), this };
        ...
        return h.forEach(function(t) { o[t] = function(e) { null != e ? this.addEventListener(t, e) : this.dispatchEvent(t) } }), this.zoom = function(t, e) {
            ...
            this.zoom(t, e)
        }, this.getCenterLocation = function() { return { x: n.stage.canvas.width / 2, y: n.stage.canvas.height / 2 } }, this.doLayout = function(t) { t && t(this, this.childs) }, this.toJson = function() {
            var t = this,
                e = "{";
            this.serializedProperties.length, this.serializedProperties.forEach(function(i) { var s = t[i]; "background" == i && (s = t._background.src), "string" == typeof s && (s = '"' + s + '"'), e += '"' + i + '":' + s + "," }), e += '"childs":[';
            var i = this.childs.length;
            return this.childs.forEach(function(t, s) { e += t.toJson(), i > s + 1 && (e += ",") }), e += "]", e += "}"
        }, n
    }
    ...
    Object.defineProperties(e.prototype, {
        background: {
            ...
            set: function(t) {
                if ("string" == typeof t) {
                    var e = i[t];
                    null == e && (e = new Image, e.src = t, e.onload = function() { i[t] = e }), this._background = e
...
function(t) {
    ...
    function i() {
        this.initialize = function() {
            ...
            var s = this,
                n = function(t) { i.call(s, t) };
            return this.messageBus || (this.messageBus = new t.util.MessageBus), this.messageBus.subscribe(e, n), this
        }, this.dispatchEvent = function(t, e) { return this.messageBus ? (this.messageBus.publish(t, e), this) : null }, this.removeEventListener = function(t) { this.messageBus.unsubscribe(t) }, this.removeAllEventListener = function() { this.messageBus = new t.util.MessageBus };
        var e = "click,dbclick,mousedown,mouseup,mouseover,mouseout,mousemove,mousedrag,touchstart,touchmove,touchend".split(","),
            s = this;
        e.forEach(function(t) { s[t] = function(e) { null != e ? this.addEventListener(t, e) : this.dispatchEvent(t) } })
    }

    function s() {
        this.initialize = function() { s.prototype.initialize.apply(this, arguments), this.editAble = !1, this.selectedPoint = null }, this.getCtrlPosition = function(t) {
            var e = 5,
                i = 5,
                s = this.getPosition(t);
            return { left: s.x - e, top: s.y - i, right: s.x + e, bottom: s.y + i }
        }, this.selectedHandler = function(e) { s.prototype.selectedHandler.apply(this, arguments), this.selectedSize = { width: this.width, height: this.height }, e.scene.mode == t.SceneMode.edit && (this.editAble = !0) }, this.unselectedHandler = function() { s.prototype.unselectedHandler.apply(this, arguments), this.selectedSize = null, this.editAble = !1 };
        ...
        this.paintCtrl = function(t) {
            ...
            if (this.selectedPoint = null, 1 == this.editAble)
                for (var n = 0; n < e.length; n++) { var h = this.getCtrlPosition(e[n]); if (t > h.left && t < h.right && i > h.top && i < h.bottom) return this.selectedPoint = e[n], !0 }
    ...
    e.prototype = new t.Element, Object.defineProperties(e.prototype, { cx: { get: function() { return this.x + this.width / 2 }, set: function(t) { this.x = t - this.width / 2 } }, cy: { get: function() { return this.y + this.height / 2 }, set: function(t) { this.y = t - this.height / 2 } } }), i.prototype = new e, s.prototype = new i, t.DisplayElement = e, t.InteractiveElement = i, t.EditableElement = s
}(JTopo),
function(t) {
    function e(i) {
        ...
        }, this.getTextPostion = function(t, e, i) { var s = null; return null == t || "Bottom_Center" == t ? s = { x: -this.width / 2 + (this.width - e) / 2, y: this.height / 2 + i } : "Top_Center" == t ? s = { x: -this.width / 2 + (this.width - e) / 2, y: -this.height / 2 - i / 2 } : "Top_Right" == t ? s = { x: this.width / 2, y: -this.height / 2 - i / 2 } : "Top_Left" == t ? s = { x: -this.width / 2 - e, y: -this.height / 2 - i / 2 } : "Bottom_Right" == t ? s = { x: this.width / 2, y: this.height / 2 + i } : "Bottom_Left" == t ? s = { x: -this.width / 2 - e, y: this.height / 2 + i } : "Middle_Center" == t ? s = { x: -this.width / 2 + (this.width - e) / 2, y: i / 2 } : "Middle_Right" == t ? s = { x: this.width / 2, y: i / 2 } : "Middle_Left" == t && (s = { x: -this.width / 2 - e, y: i / 2 }), null != this.textOffsetX && (s.x += this.textOffsetX), null != this.textOffsetY && (s.y += this.textOffsetY), s }, this.setImage = function(t, e) {
            if (null == t) throw new Error("Node.setImage(): 鍙傛暟Image瀵硅薄涓虹┖!");
            var i = this;
            if ("string" == typeof t) {
                var s = l[t];
                null == s ? (s = new Image, s.src = t, s.onload = function() { l[t] = s, 1 == e && i.setSize(s.width, s.height), i.image = s, i.alarmColor = null == i.alarmColor ? "255,0,0" : i.alarmColor }) : (e && this.setSize(s.width, s.height), i.image = s, i.alarmColor = null == i.alarmColor ? "255,0,0" : i.alarmColor)
            } else this.image = t, i.alarmColor = null == i.alarmColor ? "255,0,0" : i.alarmColor, 1 == e && this.setSize(t.width, t.height)
        }, this.removeHandler = function(t) {
            var e = this;
            this.outLinks && (this.outLinks.forEach(function(i) { i.nodeA === e && t.remove(i) }), this.outLinks = null), this.inLinks && (this.inLinks.forEach(function(i) { i.nodeZ === e && t.remove(i) }), this.inLinks = null)
        }
    }

    function i() { i.prototype.initialize.apply(this, arguments) }

    function s(t) { this.initialize(), this.text = t, this.elementType = "TextNode", this.paint = function(t) { t.beginPath(), t.font = this.font, this.width = t.measureText(this.text).width, this.height = t.measureText("鐢�").width, t.strokeStyle = "rgba(" + this.fontColor + ", " + this.alpha + ")", t.fillStyle = "rgba(" + this.fontColor + ", " + this.alpha + ")", t.fillText(this.text, -this.width / 2, this.height / 2), t.closePath(), this.paintBorder(t), this.paintCtrl(t), this.paintAlarmText(t) } }

    function n(t, e, i) {
        this.initialize(), this.text = t, this.href = e, this.target = i, this.elementType = "LinkNode", this.isVisited = !1, this.visitedColor = null, this.paint = function(t) { t.beginPath(), t.font = this.font, this.width = t.measureText(this.text).width, this.height = t.measureText("鐢�").width, this.isVisited && null != this.visitedColor ? (t.strokeStyle = "rgba(" + this.visitedColor + ", " + this.alpha + ")", t.fillStyle = "rgba(" + this.visitedColor + ", " + this.alpha + ")") : (t.strokeStyle = "rgba(" + this.fontColor + ", " + this.alpha + ")", t.fillStyle = "rgba(" + this.fontColor + ", " + this.alpha + ")"), t.fillText(this.text, -this.width / 2, this.height / 2), this.isMouseOver && (t.moveTo(-this.width / 2, this.height), t.lineTo(this.width / 2, this.height), t.stroke()), t.closePath(), this.paintBorder(t), this.paintCtrl(t), this.paintAlarmText(t) }, this.mousemove(function() {
    ...
    function h(t) { this.initialize(arguments), this._radius = 20, this.beginDegree = 0, this.endDegree = 2 * Math.PI, this.text = t, this.paint = function(t) { t.save(), t.beginPath(), t.fillStyle = "rgba(" + this.fillColor + "," + this.alpha + ")", t.arc(0, 0, this.radius, this.beginDegree, this.endDegree, !0), t.fill(), t.closePath(), t.restore(), this.paintText(t), this.paintBorder(t), this.paintCtrl(t), this.paintAlarmText(t) }, this.paintSelected = function(t) { t.save(), t.beginPath(), t.strokeStyle = "rgba(168,202,255, 0.9)", t.fillStyle = "rgba(168,202,236,0.7)", t.arc(0, 0, this.radius + 3, this.beginDegree, this.endDegree, !0), t.fill(), t.stroke(), t.closePath(), t.restore() } }
    ...
    function o(t, e, i) {
        ...
        this.nextFrame = function() {
            if (!this.isStop && null != this.frameImages.length) {
                ...
                this.setImage(this.frameImages[this.frameIndex], i), setTimeout(function() { n.nextFrame() }, s / t.length)
            }
        }
    }
    ...
    function a(t, e, i, s, n) {
        ...
        n = n || 0, this.paint = function(t) {
            ...
            if (!this.isStop) {
                ...
                setTimeout(function() { h.isStop || h.nextFrame() }, o / (e * i))
            }
        }
    }

    function r() { var t = null; return t = arguments.length <= 3 ? new o(arguments[0], arguments[1], arguments[2]) : new a(arguments[0], arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]), t.stop = function() { t.isStop = !0 }, t.play = function() { t.isStop = !1, t.frameIndex = 0, t.nextFrame() }, t }
    var l = {};
    e.prototype = new t.EditableElement, i.prototype = new e, Object.defineProperties(i.prototype, {
        ...
        width: { get: function() { return this._width }, set: function(t) { this._radius = t / 2, this._width = t } },
        height: { get: function() { return this._height }, set: function(t) { this._radius = t / 2, this._height = t } }
...
function(t) {
    ...
    function s(t) { var e = i(t.nodeA, t.nodeZ); return e = e.filter(function(e) { return t !== e }) }

    function n(t, e) { return i(t, e).length }
    ...
    function h(e, i, o) {
        ...
        this.initialize = function(e, i, s) {
            ...
            var t = this;
            this.nodeA && this.nodeA.outLinks && (this.nodeA.outLinks = this.nodeA.outLinks.filter(function(e) { return e !== t })), this.nodeZ && this.nodeZ.inLinks && (this.nodeZ.inLinks = this.nodeZ.inLinks.filter(function(e) { return e !== t }));
            var e = s(this);
            e.forEach(function(t, e) { t.nodeIndex = e })
        }, this.getStartPosition = function() { var t = { x: this.nodeA.cx, y: this.nodeA.cy }; return t }, this.getEndPosition = function() { var t; return null != this.arrowsRadius && (t = a(this.nodeZ, this.nodeA)), null == t && (t = { x: this.nodeZ.cx, y: this.nodeZ.cy }), t }, this.getPath = function() {
            var t = [],
            ...
            var h = Math.atan2(i.y - e.y, i.x - e.x),
                o = { x: e.x + this.bundleOffset * Math.cos(h), y: e.y + this.bundleOffset * Math.sin(h) },
                a = { x: i.x + this.bundleOffset * Math.cos(h - Math.PI), y: i.y + this.bundleOffset * Math.sin(h - Math.PI) },
                r = h - Math.PI / 2,
                l = h - Math.PI / 2,
                c = s * this.bundleGap / 2 - this.bundleGap / 2,
                u = this.bundleGap * this.nodeIndex,
                d = { x: o.x + u * Math.cos(r), y: o.y + u * Math.sin(r) },
                f = { x: a.x + u * Math.cos(l), y: a.y + u * Math.sin(l) };
            return d = { x: d.x + c * Math.cos(r - Math.PI), y: d.y + c * Math.sin(r - Math.PI) }, f = { x: f.x + c * Math.cos(l - Math.PI), y: f.y + c * Math.sin(l - Math.PI) }, t.push({ x: e.x, y: e.y }), t.push({ x: d.x, y: d.y }), t.push({ x: f.x, y: f.y }), t.push({ x: i.x, y: i.y }), t
            ...
            var n = this.arrowsOffset,
                ...
                f = a.y + n * Math.sin(r);
            r -= Math.PI / 2;
            var g = { x: c + h * Math.cos(r), y: u + h * Math.sin(r) },
                v = { x: c + h * Math.cos(r - Math.PI), y: u + h * Math.sin(r - Math.PI) };
        ...
        }, this.paintSelected = function(t) { t.shadowBlur = 10, t.shadowColor = "rgba(0,0,0,1)", t.shadowOffsetX = 0, t.shadowOffsetY = 0 }, this.isInBound = function(e, i) {
            if (this.nodeA === this.nodeZ) {
                var s = this.bundleGap * (this.nodeIndex + 1) / 2,
                    n = t.util.getDistance(this.nodeA, { x: e, y: i }) - s;
                return Math.abs(n) <= 3
            }
            for (var h = !1, o = 1; o < this.path.length; o++) {
                var a = this.path[o - 1],
                    r = this.path[o];
                if (1 == t.util.isPointInLine({ x: e, y: i }, a, r)) { h = !0; break }
            }
            return h
        }
    }
    ...
    function o(t, e, i) {
        this.initialize = function() { o.prototype.initialize.apply(this, arguments), this.direction = "horizontal" }, this.initialize(t, e, i), this.getStartPosition = function() { var t = { x: this.nodeA.cx, y: this.nodeA.cy }; return "horizontal" == this.direction ? this.nodeZ.cx > t.x ? t.x += this.nodeA.width / 2 : t.x -= this.nodeA.width / 2 : this.nodeZ.cy > t.y ? t.y += this.nodeA.height / 2 : t.y -= this.nodeA.height / 2, t }, this.getEndPosition = function() { var t = { x: this.nodeZ.cx, y: this.nodeZ.cy }; return "horizontal" == this.direction ? this.nodeA.cy < t.y ? t.y -= this.nodeZ.height / 2 : t.y += this.nodeZ.height / 2 : t.x = this.nodeA.cx < t.x ? this.nodeZ.x : this.nodeZ.x + this.nodeZ.width, t }, this.getPath = function(t) {
            var e = [],
            ...
            return "horizontal" == this.direction ? (h = s.x + l, o = i.y - l, e.push({ x: i.x, y: o }), e.push({ x: h, y: o }), e.push({ x: h, y: s.y })) : (h = i.x + l, o = s.y - l, e.push({ x: h, y: i.y }), e.push({ x: h, y: o }), e.push({ x: s.x, y: o })), e
        }, this.paintText = function(t, e) {
    ...
    function a(t, e, i) {
        this.initialize = function() { a.prototype.initialize.apply(this, arguments), this.direction = "vertical", this.offsetGap = 44 }, this.initialize(t, e, i), this.getStartPosition = function() { var t = { x: this.nodeA.cx, y: this.nodeA.cy }; return "horizontal" == this.direction ? t.x = this.nodeZ.cx < t.x ? this.nodeA.x : this.nodeA.x + this.nodeA.width : t.y = this.nodeZ.cy < t.y ? this.nodeA.y : this.nodeA.y + this.nodeA.height, t }, this.getEndPosition = function() { var t = { x: this.nodeZ.cx, y: this.nodeZ.cy }; return "horizontal" == this.direction ? t.x = this.nodeA.cx < t.x ? this.nodeZ.x : this.nodeZ.x + this.nodeZ.width : t.y = this.nodeA.cy < t.y ? this.nodeZ.y : this.nodeZ.y + this.nodeZ.height, t }, this.getPath = function(t) {
            ...
            var s = [],
                ...
                r = this.offsetGap;
            return "horizontal" == this.direction ? (this.nodeA.cx > this.nodeZ.cx && (r = -r), s.push({ x: e.x, y: e.y + a }), s.push({ x: e.x + r, y: e.y + a }), s.push({ x: i.x - r, y: i.y + a }), s.push({ x: i.x, y: i.y + a })) : (this.nodeA.cy > this.nodeZ.cy && (r = -r), s.push({ x: e.x + a, y: e.y }), s.push({ x: e.x + a, y: e.y + r }), s.push({ x: i.x + a, y: i.y - r }), s.push({ x: i.x + a, y: i.y })), s
        }
    }

    function r(t, e, i) {
        this.initialize = function() { r.prototype.initialize.apply(this, arguments) }, this.initialize(t, e, i), this.paintPath = function(t, e) {
            if (this.nodeA === this.nodeZ) return void this.paintLoop(t);
            t.beginPath(), t.moveTo(e[0].x, e[0].y);
...
function(t) {
    function e(i) {
        ...
        }, this.doLayout = function(t) { t && t(this, this.childs) }, this.paint = function(t) { this.visible && (this.layout && this.layout(this, this.childs), t.beginPath(), t.fillStyle = "rgba(" + this.fillColor + "," + this.alpha + ")", null == this.borderRadius || 0 == this.borderRadius ? t.rect(this.x, this.y, this.width, this.height) : t.JTopoRoundRect(this.x, this.y, this.width, this.height, this.borderRadius), t.fill(), t.closePath(), this.paintText(t), this.paintBorder(t)) }, this.paintBorder = function(t) {
            if (0 != this.borderWidth) {
                t.beginPath(), t.lineWidth = this.borderWidth, t.strokeStyle = "rgba(" + this.borderColor + "," + this.alpha + ")";
                var e = this.borderWidth / 2;
        ...
        }, this.getTextPostion = function(t, e, i) { var s = null; return null == t || "Bottom_Center" == t ? s = { x: this.x + this.width / 2 - e / 2, y: this.y + this.height + i } : "Top_Center" == t ? s = { x: this.x + this.width / 2 - e / 2, y: this.y - i / 2 } : "Top_Right" == t ? s = { x: this.x + this.width - e, y: this.y - i / 2 } : "Top_Left" == t ? s = { x: this.x, y: this.y - i / 2 } : "Bottom_Right" == t ? s = { x: this.x + this.width - e, y: this.y + this.height + i } : "Bottom_Left" == t ? s = { x: this.x, y: this.y + this.height + i } : "Middle_Center" == t ? s = { x: this.x + this.width / 2 - e / 2, y: this.y + this.height / 2 + i / 2 } : "Middle_Right" == t ? s = { x: this.x + this.width - e, y: this.y + this.height / 2 + i / 2 } : "Middle_Left" == t && (s = { x: this.x, y: this.y + this.height / 2 + i / 2 }), null != this.textOffsetX && (s.x += this.textOffsetX), null != this.textOffsetY && (s.y += this.textOffsetY), s }, this.paintMouseover = function() {}, this.paintSelected = function(t) { t.shadowBlur = 10, t.shadowColor = "rgba(0,0,0,1)", t.shadowOffsetX = 0, t.shadowOffsetY = 0 }
    }
...
function(t) {
    function e(t) {
        var e = 0,
            i = 0;
        t.forEach(function(t) { e += t.cx, i += t.cy });
        var s = { x: e / t.length, y: i / t.length };
        return s
    }
    ...
    function i(i, s) {
        ...
        var u = 0,
            d = [],
            f = [];
        i.forEach(function(t) { null == s.nodeDiameter ? (t.diameter && (a = t.diameter), a = t.radius ? 2 * t.radius : Math.sqrt(2 * t.width * t.height), f.push(a)) : f.push(a), u += a }), i.forEach(function(t, e) {
            var i = f[e] / u;
            d.push(Math.PI * i)
        });
        ...
        if (x) {
            ...
            i.forEach(function(e, i) {
                ...
                var s = n + Math.cos(b) * m,
                    o = h + Math.sin(b) * y;
                t.Animate.stepByStep(e, { x: s - e.width / 2, y: o - e.height / 2 }, w).start()
            })
        } else {
            var b = 0;
        ...
        return { cx: n, cy: h, radius: m, radiusA: m, radiusB: y }
    }
    ...
    function a(t) {
        var e = 0,
            i = 0;
        return t.forEach(function(t) { e += t.width, i += t.height }), { width: e / t.length, height: i / t.length }
    }

    function r(t, e, i, s) { e.x += i, e.y += s; for (var n = p(t, e), h = 0; h < n.length; h++) r(t, n[h], i, s) }
    ...
    function c(e, i, s) {
        return function(n) {
            ...
            if (c.length > 0) {
                ...
                n.childs.forEach(function(e) { e instanceof t.Node && (e.x += f, e.y += g) })
            }
        }
    }
    ...
    function u(e) {
        return function(i) {
            ...
            if (n.length > 0) {
                ...
                i.childs.forEach(function(e) { e instanceof t.Node && (e.x += a, e.y += r) })
            }
        }
    }
    ...
    function d(t, e, i, s, n, h) {
        for (var o = [], a = 0; i > a; a++)
            for (var r = 0; s > r; r++) o.push({ x: t + r * n, y: e + a * h });
        return o
    }
    ...
    function g(t, e, i, s, n, h) {
        var o = h || "bottom",
            a = [];
        if ("bottom" == o)
            for (var r = t - i / 2 * s + s / 2, l = 0; i >= l; l++) a.push({ x: r + l * s, y: e + n });
        else if ("top" == o)
            for (var r = t - i / 2 * s + s / 2, l = 0; i >= l; l++) a.push({ x: r + l * s, y: e - n });
        else if ("right" == o)
            for (var r = e - i / 2 * s + s / 2, l = 0; i >= l; l++) a.push({ x: t + n, y: r + l * s });
        else if ("left" == o)
            for (var r = e - i / 2 * s + s / 2, l = 0; i >= l; l++) a.push({ x: t - n, y: r + l * s });
        return a
    }
    ...
    function p(e, i) { for (var s = [], n = 0; n < e.length; n++) e[n] instanceof t.Link && e[n].nodeA === i && s.push(e[n].nodeZ); return s }
    ...
    t.layout = t.Layout = { layoutNode: m, getNodeChilds: p, adjustPosition: v, springLayout: y, getTreeDeep: x, getRootNodes: o, GridLayout: s, FlowLayout: n, AutoBoundLayout: h, CircleLayout: u, TreeLayout: c, getNodesCenter: e, circleLayoutNodes: i }
}(JTopo),
function(t) {
    function e() {
...
function(t) {
    function e(e, i) { var s, n = null; return { stop: function() { return s ? (window.clearInterval(s), n && n.publish("stop"), this) : this }, start: function() { var t = this; return s = setInterval(function() { e.call(t) }, i), this }, onStop: function(e) { return null == n && (n = new t.util.MessageBus), n.subscribe("stop", e), this } } }
    ...
    function i(t, i) {
        ...
        var s = i.gravity || .1,
            ...
            o = i.stop,
            a = i.interval || 30,
            r = new e(function() { o && o() ? (h = .5, this.stop()) : (h += s, t.setLocation(t.x + n, t.y + h)) }, a);
        return r
    }
    ...
    function s(t, i, s, n, h) {
        ...
        for (var r in i) {
            var l = i[r],
                c = l - t[r];
            a[r] = { oldValue: t[r], targetValue: l, step: c / s * o, isDone: function(e) { var i = this.step > 0 && t[e] >= this.targetValue || this.step < 0 && t[e] <= this.targetValue; return i } }
        }
    ...
    function n(t) {
        ...
        return {
            ...
            timer: null,
            isPause: !1,
            addNode: function(t, e) { var i = { node: t, target: e, vx: 0, vy: 0 }; return this.items.push(i), this },
            play: function(t) {
                this.stop(), t = null == t ? 1e3 / 24 : t;
                var e = this;
                this.timer = setInterval(function() { e.nextFrame() }, t)
            },
    ...
    function h(t, e) {
        function i() { return n = setInterval(function() { return g ? void h.stop() : (t.rotate += o || .2, void(t.rotate > 2 * Math.PI && (t.rotate = 0))) }, 100), h }

        function s() { return window.clearInterval(n), h.onStop && h.onStop(t), h }
        var n = (e.context, null),
            h = {},
            o = e.v;
        return h.run = i, h.stop = s, h.onStop = function(t) { return h.onStop = t, h }, h
    }

    function o(t, e) {
        function i() { return window.clearInterval(o), a.onStop && a.onStop(t), a }

        function s() {
            var s = e.dx || 0,
                r = e.dy || 2;
            return o = setInterval(function() { return g ? void a.stop() : (r += h, void(t.y + t.height < n.stage.canvas.height ? t.setLocation(t.x + s, t.y + r) : (r = 0, i()))) }, 20), a
        }
        var n = e.context,
            h = e.gravity || .1,
            o = null,
            a = {};
        return a.run = s, a.stop = i, a.onStop = function(t) { return a.onStop = t, a }, a
    }

    function a(e, i) {
        function s(i, s, n, h, o) { var a = new t.Node; return a.setImage(e.image), a.setSize(e.width, e.height), a.setLocation(i, s), a.showSelected = !1, a.dragable = !1, a.paint = function(t) { t.save(), t.arc(0, 0, n, h, o), t.clip(), t.beginPath(), null != this.image ? t.drawImage(this.image, -this.width / 2, -this.height / 2) : (t.fillStyle = "rgba(" + this.style.fillStyle + "," + this.alpha + ")", t.rect(-this.width / 2, -this.height / 2, this.width / 2, this.height / 2), t.fill()), t.closePath(), t.restore() }, a }
        ...
        function n(i, n) {
            ...
            e.visible = !1, n.add(a), n.add(l), t.Animate.gravity(a, { context: n, dx: .3 }).run().onStop(function() { n.remove(a), n.remove(l), r.stop() }), t.Animate.gravity(l, { context: n, dx: -.2 }).run()
        }

        function h() { return n(i.angle, a), r }

        function o() { return r.onStop && r.onStop(e), r }
        var a = i.context,
            r = (e.style, {});
        return r.onStop = function(t) { return r.onStop = t, r }, r.run = h, r.stop = o, r
    }
    ...
    function r(t, e) {
        ...
        function s() { return i(t), a = setInterval(function() { return g ? void r.stop() : (t.vy += h, t.x += t.vx, t.y += t.vy, void((t.x < 0 || t.x > o.stage.canvas.width || t.y > o.stage.canvas.height) && (r.onStop && r.onStop(t), i(t)))) }, 50), r }

        function n() { window.clearInterval(a) }
        var h = .8,
            o = e.context,
            a = null,
            r = {};
        return r.onStop = function(t) { return r.onStop = t, r }, r.run = s, r.stop = n, r
    }
    ...
    function u(e, i) {
        ...
        function n() { window.clearInterval(f) }
        var h = i.p1,
            o = i.p2,
    ...
    function d(t, e) {
        ...
        function s() { window.clearInterval(a) }
        var n = e.position,
            h = (e.context, e.easing || .2),
            o = {},
            a = null;
        return o.onStop = function(t) { return o.onStop = t, o }, o.run = i, o.stop = s, o
    }

    function f(t, e) {
        function i() { return l = setInterval(function() { t.scaleX += h, t.scaleY += h, t.scaleX >= n && s() }, 100), r }

        function s() { r.onStop && r.onStop(t), t.scaleX = o, t.scaleY = a, window.clearInterval(l) }
        var n = (e.position, e.context, e.scale || 1),
            ...
            r = {},
            l = null;
        return r.onStop = function(t) { return r.onStop = t, r }, r.run = i, r.stop = s, r
    }
    t.Animate = {}, t.Effect = {};
    var g = !1;
...
function(t) {
    function e(t, e) {
        ...
        var s = e.match(/^\s*(\w+)\s*$/);
        if (null != s) {
            var n = t.filter(function(t) { return t.elementType == s[1] });
            ...
            if (s = e.match(/\s*(\w+)\s*\[\s*(\w+)\s*([>=<])\s*['"](\S+)['"]\s*\]\s*/), (null == s || s.length < 5) && (s = e.match(/\s*(\w+)\s*\[\s*(\w+)\s*([>=<])\s*(\d+(\.\d+)?)\s*\]\s*/), h = !0), null != s && s.length >= 5) {
                var o = s[1],
                    ...
                    r = s[3],
                    l = s[4];
                n = t.filter(function(t) { if (t.elementType != o) return !1; var e = t[a]; return 1 == h && (e = parseInt(e)), "=" == r ? e == l : ">" == r ? e > l : "<" == r ? l > e : "<=" == r ? l >= e : ">=" == r ? e >= l : "!=" == r && e != l }), null != n && n.length > 0 && (i = i.concat(n))
            }
        }
        return i
    }
    ...
    function i(t) {
        if (t.find = function(t) { return s.call(this, t) }, n.forEach(function(e) { t[e] = function(t) { for (var i = 0; i < this.length; i++) this[i][e](t); return this } }), t.length > 0) { var e = t[0]; for (var i in e) { var h = e[i]; "function" == typeof h && ! function(e) { t[i] = function() { for (var i = [], s = 0; s < t.length; s++) i.push(e.apply(t[s], arguments)); return i } }(h) } }
        return t.attr = function(t, e) {
            if (null != t && null != e)
                for (var i = 0; i < this.length; i++) this[i][t] = e;
            else {
                if (null != t && "string" == typeof t) { for (var s = [], i = 0; i < this.length; i++) s.push(this[i][t]); return s }
                if (null != t)
    ...
    function s(s) {
        var n = [],
            h = [];
        this instanceof t.Stage ? (n = this.childs, h = h.concat(n)) : this instanceof t.Scene ? n = [this] : h = this, n.forEach(function(t) { h = h.concat(t.childs) });
        var o = null;
...
function(t) {
    ...
    function i(t) { this.p = new e(0, 0), this.w = new e(1, 0), this.paint = t }

    function s(t, e, i) { return function(s) { for (var n = 0; e > n; n++) t(), i && s.turn(i), s.move(3) } }

    function n(t, e) { var i = 2 * Math.PI; return function(s) { for (var n = 0; e > n; n++) t(), s.turn(i / e) } }

    function h(t, e, i) { return function(s) { for (var n = 0; e > n; n++) t(), s.resize(i) } }

    function o(t) { var e = 2 * Math.PI; return function(i) { for (var s = 0; t > s; s++) i.forward(1), i.turn(e / t) } }

    function a(t) { var e = 4 * Math.PI; return function(i) { for (var s = 0; t > s; s++) i.forward(1), i.turn(e / t) } }

    function r(t, e, i, s) { return function(n) { for (var h = 0; e > h; h++) t(), n.forward(1), n.turn(i), n.resize(s) } }
    var l = {};
    ...
    }, i.prototype.moveTo = function(t, e) { return this.p.x = t, this.p.y = e, this }, i.prototype.turn = function(t) {
        var e = (this.p, this.w),
            i = Math.cos(t) * e.x - Math.sin(t) * e.y,
            s = Math.sin(t) * e.x + Math.cos(t) * e.y;
        return e.x = i, e.y = s, this
    }, i.prototype.resize = function(t) { var e = this.w; return e.x = e.x * t, e.y = e.y * t, this }, i.prototype.save = function() { return null == this._stack && (this._stack = []), this._stack.push([this.p, this.w]), this }, i.prototype.restore = function() {
