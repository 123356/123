        ...
        if (ss.length > 0) {
            ...
            for (var t in ss) {
                if (ss[t].PlanDate != "") {
                    ...
                    var str = JSON.stringify(ss[t]);
                    if (i > 1) {
                        result = result + "<tr><th>" + i + "、" + time.substring(0, time.indexOf('T')) + "</th><td><button " + sss + " class=\"" + s + "\" onclick='clickOrder(" + str + ")'>" + xx + "</button></td></tr>"
                    }
                    else
                        result = "<tr><th>" + i + "、" + time.substring(0, time.indexOf('T')) + "</th><td><button " + sss + " class=\"" + s + "\" onclick='clickOrder(" + str + ")'>" + xx + "</button></td></tr>"
                    i++;
                }
            }
        }
