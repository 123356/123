    ...
    Calendar.prototype = {
        ...
        renderDOM: function () { // 渲染DOM
            ...
            for (var i = 0; i < 6; i++) {
                ...
                _dateStr += '<li class="item" onclick="show(this)"></li>' +
                            '<li class="item"  onclick="show(this)"></li>' +
                            '<li class="item"  onclick="show(this)"></li>' +
                            '<li class="item"  onclick="show(this)"></li>' +
                            '<li class="item"  onclick="show(this)"></li>' +
                            '<li class="item"  onclick="show(this)"></li>' +
        ...
        inital: function () { // 初始化
            ...
            if (this.opts.ifSwitch) {
                this.$arrow_prev.bind('click', function () {
                    ...
                    $.cookie('isClick', true, { expires: 7, path: '/' });
...
function show(e) {
    var time = e.attributes.data.value
    time = time.substring(0, 4) + "-" + time.substring(4, 6) + "-" + time.substring(6, 8)
    console.log(time)
    $.cookie('calendar', time, { expires: 7 });
}
