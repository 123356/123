...
$(function () {
    ...
    if (-2 == iRet) {
        ...
        top.openDialog("../../HaiKang/cn/download.html", 'download', '温馨提示', 500, 130, 50, 50);
        return;
    }

    // 初始化插件参数及插入插件
    WebVideoCtrl.I_InitPlugin(900, 700, {
...
function clickLogin() {
    ...
    var szIP = Request['IP'];
    var szPort = Request['mediaport'];
    var szUsername = Request['user'];
    var szPassword = Request['passwd'];
    var szDrv = Request['Jump2Drv'];
